...
import { PlusIcon, UploadCloudIcon, FilePenLineIcon, TrashIcon, PencilIcon, XIcon, LoaderCircleIcon, SparklesIcon } from "lucide-react";
        ...
        <div>
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="flex gap-4">
                    ...
                    <button onClick={() => navigate('/app/ai-analyzer')} className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
                        <SparklesIcon className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-purple-400 to-indigo-600 text-white rounded-full" />
                        <p className="text-sm group-hover:text-indigo-600 transition-all duration-300 text-center">Smart AI Analyzer</p>
                    </button>
                </div>
