export default function Footer() {
    return (
        <>
            ...
            `}</style>
            <footer className='bg-black py-12 px-4 sm:px-6 lg:px-8 mt-5'>
                <div className='w-full max-w-7xl mx-auto'>
                    ...
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                        ...
                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <p className='text-sm text-white/60 mt-6 max-w-sm leading-relaxed'>
                                We're on a mission to help job seekers land their dream careers by creating intelligent, ATS-optimized resumes that stand out in today's competitive job market.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className='text-xs text-white/60'>© 2026 ResumeIQ</p>
